                                    ...
                                    <div class="row gy-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="input" name="title"
                                                ...
                                                value="<?php echo e(isset($page) ? $page->title : old('title')); ?>" />
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-2 "><b> Content : </b></p>

                                            <textarea name="content" id="editor" cols="30" rows="20">
                                                    <?php echo e(isset($page) ? $page->content : old('content')); ?>
...
<?php /**PATH C:\Users\DESKTOP\Desktop\Elle Laravel Blog\resources\views/admin/create-static-page.blade.php ENDPATH**/ ?>