                                    ...
                                    <table id="datatable-basic" class="table table-bordered text-nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo e(Str::title($page->title)); ?> </td>
                                               
                                                <td style="">
                                                    <a href="<?php echo e(route('static-page',['slug'=> $page->slug])); ?>"
                                                        style="
                                                        background: rgb(92, 223, 90);
                                                        padding: 10px;
                                                        padding-left: 20px;
                                                        padding-right: 20px;
                                                        margin : 10px;
                                                    ...
                                                    <a href="<?php echo e(route('update-page',['id'=> $page->id])); ?>"
                                                            style="
                                                    ...
                                                    <a href="<?php echo e(route('delete-page',['id'=> $page->id])); ?>"
                                                        style="
...
<?php /**PATH C:\Users\DESKTOP\Desktop\Elle Laravel Blog\resources\views/admin/all_static_pages.blade.php ENDPATH**/ ?>