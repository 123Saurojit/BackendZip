    ...
    <div class="css-1ss7lvu eluqz9n10">
        ...
        <nav data-track-type="footer-menu" role="navigation" aria-label="Footer" class="css-kzigki eluqz9n8">
            ...
            <a target="_blank" rel="noopener"
                data-theme-key="base-link" href="<?php echo e($url); ?>"
                class="css-1vc4yu1 e1c1bym14"><?php echo e($title); ?>
        ...
        <div data-track-type="legal-footer-menu" class="css-lqx6q4 eluqz9n2">
            ...
            <?php $__currentLoopData = $allStatic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a target="_blank" rel="noopener"
                data-theme-key="base-link" href="<?php echo e($url); ?>"
                class="css-r7fsoq e1c1bym14"><?php echo e($title); ?>
...
</footer><?php /**PATH C:\Users\DESKTOP\Desktop\Elle Laravel Blog\resources\views/pages/layouts/footer.blade.php ENDPATH**/ ?>