        ...
        <main id="main-content" class="css-rk6tbh ewq0ot90">
                ...
                <a data-theme-key="custom-item" label="" data-vars-cta="FASHION" data-vars-ga-position="1"
                    ...
                    <div data-theme-key="custom-item-content" class="css-15nifei ee4ms350">
                        <h2 data-theme-key="custom-item-title" class="css-17nzgrb e10ip9lg6">
                            <span aria-hidden="true" data-theme-key="title-design-element-before"
                                class="css-1dmjnw1 eagam8p0"></span><span data-theme-key="custom-item-title-text"
                                class="css-hnknpq e10ip9lg5">{{ $title }}</span><span aria-hidden="true" data-theme-key="title-design-element-after"
                        ...
                        <span class="css-1fv2c70 e10ip9lg2">
                            <section data-lazy-parent="P0-7">
                                <address class="css-rhj3ne e1v8cotw2">
                                    <span data-theme-key="by-line-name" class="css-1qat9tq e1v8cotw1"><span>By {{ $author }}</span></span>
                                </address>
                            </section>
                        </span>
                    </div>
            ...
            <section data-vars-block-curation="curated" data-vars-block-type="4 Across Block" data-vars-block-slot="3"
                ...
                <div data-theme-key="block-header" class="css-1sr6p3x eqz7u0o2">
                    <h2 data-theme-key="block-heading" class="css-1e39s00 eqz7u0o1">
                        <span aria-hidden="true" data-theme-key="title-design-element-before"
                            class="css-0 eagam8p0"></span><a data-theme-key="base-link"
                            href="/category/Elle Brillante/" class="css-0 e1c1bym14" style="text">{{ strtoupper('Elle Brillante') }}</a><span
                            aria-hidden="true" data-theme-key="title-design-element-after"
                            class="css-0 eagam8p1"></span>
                    </h2>
                </div>
                
                <x-short-card :posts="$ellePosts->slice(0,4)" />
                ...
                <div data-theme-key="big-story-feed-block-container" class="css-1o1ws1x eq9yxe32">
                    ...
                    <div>
                        <div data-theme-key="big-story-feed-basefeed-container" class="css-hhmn3a eq9yxe33">
                            ...
                            @foreach ($beautyPosts->slice(1,4) as $post)
                            ...
                            <a data-theme-key="custom-item" label="" data-vars-cta="BEAUTY" data-vars-ga-position="2"
                                ...
                                <div data-theme-key="custom-item-content" class="css-1a613ux ee4ms350">
                                    <h2 data-theme-key="custom-item-title" class="css-17nzgrb e10ip9lg6">
                                        <span aria-hidden="true" data-theme-key="title-design-element-before"
                                            class="css-0 eagam8p0"></span><span data-theme-key="custom-item-title-text"
                                            class="css-8x9owz e10ip9lg5">{{ $title }}</span><span
                                            aria-hidden="true" data-theme-key="title-design-element-after"
                                            class="css-0 eagam8p1"></span>
                                    </h2>
                                    <span class="css-1fv2c70 e10ip9lg2">
                                        <section data-lazy-parent="P0-9">
                                            <address class="css-gouovr e1v8cotw2">
                                                <span data-theme-key="by-line-name"
                                                    class="css-1eedjog e1v8cotw1"><span>By {{ $author }}</span></span>
                                            </address>
                                        </section>
                                    </span>
                                </div>
            ...
            <section data-vars-block-curation="curated" data-vars-block-type="Big Story Feed Block"
                ...
                <div data-theme-key="big-story-feed-block-container" class="css-wgm1ip eq9yxe32">
                    ...
                    @foreach ($cultPosts->slice(0,1) as $post)
                    ...
                    <div>
                        <div data-theme-key="big-story-feed-basefeed-container" class="css-1ow0w5y eq9yxe33">
                            ...
                            @foreach ($cultPosts->slice(1,4) as $post)
                            ...
                            <a data-theme-key="custom-item" label="" data-vars-cta="CULTURE" data-vars-ga-position="2"
                                ...
                                <div data-theme-key="custom-item-content" class="css-0 ee4ms350">
                                    <h2 data-theme-key="custom-item-title" class="css-17nzgrb e10ip9lg6">
                                        <span aria-hidden="true" data-theme-key="title-design-element-before"
                                            class="css-0 eagam8p0"></span><span data-theme-key="custom-item-title-text"
                                            class="css-1fld8nl e10ip9lg5">{{ $title }}</span><span aria-hidden="true"
                                            data-theme-key="title-design-element-after" class="css-0 eagam8p1"></span>
                                    </h2>
                                    <span class="css-1fv2c70 e10ip9lg2">
            ...
            <section data-vars-block-curation="curated" data-vars-block-type="4 Across Block" data-vars-block-slot="6"
                ...
                <x-short-card :posts="$horoPosts->slice(0,4)"/>

            </section>

            @foreach ($polPosts->slice(0,1) as $post)
                ...
                <a data-theme-key="custom-item" label="" data-vars-cta="NEWS & POLITICS" data-vars-ga-position="1"
                    ...
                    <div data-theme-key="custom-item-content" class="css-hoj2rk ee4ms350">
                        <h2 data-theme-key="custom-item-title" class="css-17nzgrb e10ip9lg6">
                            <span aria-hidden="true" data-theme-key="title-design-element-before"
                                class="css-1dmjnw1 eagam8p0"></span><span data-theme-key="custom-item-title-text"
                                class="css-q3yz31 e10ip9lg5">{{ $title }} </span><span aria-hidden="true" data-theme-key="title-design-element-after"
                                class="css-ha23m7 eagam8p1"></span>
                        </h2>
            ...
            <section data-vars-block-curation="curated" data-vars-block-type="4 Across Block" data-vars-block-slot="8"
                ...
                <x-short-card :posts="$randomPosts->slice(0,4)" />

                
            </section>

            {{-- <section data-vars-block-curation="curated" data-vars-block-type="4 Across Block" data-vars-block-slot="9"
                data-vars-block-id="e2c8c941-dad4-4f15-9815-054094fa3ad5" data-vars-block-heading="FEATURES"
                id="e5cef27b-3213-46dc-a3ed-014628287381" data-lazy-id="P0-14" class="css-1tddtcr ezpcz1b0">
                <div data-theme-key="block-header" class="css-1sr6p3x eqz7u0o2">
                    <h2 data-theme-key="block-heading" class="css-1e39s00 eqz7u0o1">
                        <span aria-hidden="true" data-theme-key="title-design-element-before"
                            class="css-0 eagam8p0"></span><a data-theme-key="base-link"
                            href="https://www.elle.com/long-reads/" class="css-0 e1c1bym14">FEATURES</a><span
                            aria-hidden="true" data-theme-key="title-design-element-after"
                            class="css-0 eagam8p1"></span>
                    </h2>
                </div>
                <div data-theme-key="four-across-layout" class="css-3ioj3p ezpcz1b1">
                    <a data-theme-key="custom-item" label="" data-vars-cta="FEATURES" data-vars-ga-position="1"
                        data-vars-ga-call-to-action="Chloe Coscarelli Is Reclaiming Her Name"
                        data-vars-ga-outbound-link="https://www.elle.com/culture/a61679901/chef-chloe-coscarelli-interview-2024/"
                        href="/culture/a61679901/chef-chloe-coscarelli-interview-2024/"
                        class="ee4ms352 css-1pxdqsn e1c1bym14">
                        <div data-vars-cta="FEATURES" data-vars-ga-position="1"
                            data-vars-ga-call-to-action="Chloe Coscarelli Is Reclaiming Her Name"
                            data-vars-ga-outbound-link="https://www.elle.com/culture/a61679901/chef-chloe-coscarelli-interview-2024/"
                            class="css-ftsoqv ee4ms351">
                            <img src="images/chloecoscarelli-563edit-66a060ee6da72.jpg" alt="a woman sitting on a step"
                                title="a woman sitting on a step" width="100%" height="auto" decoding="async"
                                loading="lazy" />
                        </div>
                        <div data-theme-key="custom-item-content" class="css-1dc3fjj ee4ms350">
                            <h2 data-theme-key="custom-item-title" class="css-17nzgrb e10ip9lg6">
                                <span aria-hidden="true" data-theme-key="title-design-element-before"
                                    class="css-0 eagam8p0"></span><span data-theme-key="custom-item-title-text"
                                    class="css-m39hn e10ip9lg5">Chloe Coscarelli Is Reclaiming Her
                                    Name</span><span aria-hidden="true" data-theme-key="title-design-element-after"
                                    class="css-0 eagam8p1"></span>
                            </h2>
                        </div>
                    </a><a data-theme-key="custom-item" label="" data-vars-cta="FEATURES" data-vars-ga-position="2"
                        data-vars-ga-call-to-action="Kesha Freed Herself. Now She’s Saving Music."
                        data-vars-ga-outbound-link="https://www.elle.com/culture/celebrities/a62470735/kesha-new-album-interview-2024/"
                        href="/culture/celebrities/a62470735/kesha-new-album-interview-2024/"
                        class="ee4ms352 css-1pxdqsn e1c1bym14">
                        <div data-vars-cta="FEATURES" data-vars-ga-position="2"
                            data-vars-ga-call-to-action="Kesha Freed Herself. Now She’s Saving Music."
                            data-vars-ga-outbound-link="https://www.elle.com/culture/celebrities/a62470735/kesha-new-album-interview-2024/"
                            class="css-ftsoqv ee4ms351">
                            <img src="images/elm110124ppkesha-004-66fc364ace973.jpg" alt="kesha" title="kesha"
                        ...
                        <div data-theme-key="custom-item-content" class="css-1dc3fjj ee4ms350">
                            <h2 data-theme-key="custom-item-title" class="css-17nzgrb e10ip9lg6">
                                <span aria-hidden="true" data-theme-key="title-design-element-before"
                                    class="css-0 eagam8p0"></span><span data-theme-key="custom-item-title-text"
                                    class="css-m39hn e10ip9lg5">Kesha Freed Herself. Now She’s Saving
                                    Music.</span><span aria-hidden="true" data-theme-key="title-design-element-after"
                                    class="css-0 eagam8p1"></span>
                            </h2>
                        </div>
                    </a><a data-theme-key="custom-item" label="" data-vars-cta="FEATURES" data-vars-ga-position="3"
                        data-vars-ga-call-to-action="This Japanese Filmmaker Investigated Her Assault"
                        data-vars-ga-outbound-link="https://www.elle.com/culture/movies-tv/a62651089/shiori-ito-sexual-assault-black-box-diaries-interview-2024/"
                        href="/culture/movies-tv/a62651089/shiori-ito-sexual-assault-black-box-diaries-interview-2024/"
                        class="ee4ms352 css-1pxdqsn e1c1bym14">
                        <div data-vars-cta="FEATURES" data-vars-ga-position="3"
                            data-vars-ga-call-to-action="This Japanese Filmmaker Investigated Her Assault"
                            data-vars-ga-outbound-link="https://www.elle.com/culture/movies-tv/a62651089/shiori-ito-sexual-assault-black-box-diaries-interview-2024/"
                            class="css-ftsoqv ee4ms351">
                            <img src="images/director-shiori-ito-1-photo-by-oliver-abraham-jpg-67164967a64a7.jpg"
                                alt="shiori ito with one arm bent and the chin resting on the hand"
                                title="shiori ito with one arm bent and the chin resting on the hand" width="100%"
                        ...
                        <div data-theme-key="custom-item-content" class="css-1dc3fjj ee4ms350">
                            <h2 data-theme-key="custom-item-title" class="css-17nzgrb e10ip9lg6">
                                <span aria-hidden="true" data-theme-key="title-design-element-before"
                                    class="css-0 eagam8p0"></span><span data-theme-key="custom-item-title-text"
                                    class="css-m39hn e10ip9lg5">This Japanese Filmmaker Investigated
                                    Her Assault</span><span aria-hidden="true"
                                    data-theme-key="title-design-element-after" class="css-0 eagam8p1"></span>
                            </h2>
                        </div>
                    </a><a data-theme-key="custom-item" label="" data-vars-cta="FEATURES" data-vars-ga-position="4"
                        data-vars-ga-call-to-action="Rebecca Minkoff Is Ready for <i>RHONY</i>"
                        data-vars-ga-outbound-link="https://www.elle.com/culture/celebrities/a62246059/rebecca-minkoff-rhony-interview-2024/"
                        href="/culture/celebrities/a62246059/rebecca-minkoff-rhony-interview-2024/"
                        class="ee4ms352 css-1pxdqsn e1c1bym14">
                        <div data-vars-cta="FEATURES" data-vars-ga-position="4"
                            data-vars-ga-call-to-action="Rebecca Minkoff Is Ready for <i>RHONY</i>"
                            data-vars-ga-outbound-link="https://www.elle.com/culture/celebrities/a62246059/rebecca-minkoff-rhony-interview-2024/"
                            class="css-ftsoqv ee4ms351">
                            <img src="images/elm080124-dig-rebecca-minkoff-003-66e9d15ea079d.jpg" alt="rebecca minkoff"
                                title="rebecca minkoff" width="100%" height="auto" decoding="async" loading="lazy" />
                        </div>
                        <div data-theme-key="custom-item-content" class="css-1dc3fjj ee4ms350">
                            <h2 data-theme-key="custom-item-title" class="css-17nzgrb e10ip9lg6">
                                <span aria-hidden="true" data-theme-key="title-design-element-before"
                                    class="css-0 eagam8p0"></span><span data-theme-key="custom-item-title-text"
                                    class="css-m39hn e10ip9lg5">Rebecca Minkoff Is Ready for
                                    <i>RHONY</i></span><span aria-hidden="true"
                                    data-theme-key="title-design-element-after" class="css-0 eagam8p1"></span>
                            </h2>
                        </div>
                    </a>
            ...
            <section data-vars-block-curation="collection" data-vars-block-type="3 Column Block"
                ...
                <div data-theme-key="three-columns-block-container" class="css-w9tso1 emk51de1">
                    <div data-theme-key="block-column" class="css-19z6se emk51de0">
                        ...
                        @foreach ($foodPosts->slice(0,4) as $post)
                            @php
                                $url = route('blog', ['slug' => $post->slug]);
                                $title = Str::title($post->title);
                                $image = $post->thumbnail;
                    ...
                    <div data-theme-key="block-column" class="css-19z6se emk51de0">
                        ...
                        @foreach ($trendingPosts->slice(0,4) as $post)
                            @php
                                $url = route('blog', ['slug' => $post->slug]);
                                $title = Str::title($post->title);
                                $image = $post->thumbnail;
                    ...
                    <div data-theme-key="block-column" class="css-19z6se emk51de0">
                        ...
                        @foreach ($travPosts->slice(0,4) as $post)
                        @php
                            $url = route('blog', ['slug' => $post->slug]);
                            $title = Str::title($post->title);
                            $image = $post->thumbnail;
            ...
            <section data-vars-block-curation="site" data-vars-block-type="Page Content Block" data-vars-block-slot="12"
                ...
                <x-short-card :posts="$recentPosts->slice(1,12)" />
